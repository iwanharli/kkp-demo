    ...
    <div className="landing-page-container">
      ...
      <nav>
        <div className="nav-logo">
          ...
          NEXGOV · BLUE ECONOMY CONTROL TOWER
        </div>
      ...
      <div className="hero">
        ...
        <div>
          ...
          <h1><span className="blue">Blue Economy</span></h1>
          <h2>Control Tower Dashboard</h2>
      ...
      */}
      ...
      <section id="modul" className="reveal">
        ...
        <h2 className="section-title">5 Modul <span className="hl">Terintegrasi</span> NexGov</h2>
      ...
      <section id="teknologi" className="reveal">
        ...
        <p className="section-desc">Blue Economy Control Tower menggunakan kombinasi teknologi AI terdepan yang disesuaikan khusus untuk kebutuhan pemantauan ruang laut, perizinan, dan sentimen sosial pesisir.</p>
...
*/}
      ...
      <footer>
        <div className="logo">🌊 NEXGOV · BLUE ECONOMY CONTROL TOWER</div>
